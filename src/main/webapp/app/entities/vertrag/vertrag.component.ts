...
export class VertragComponent implements OnInit, OnDestroy {
  vertrags?: IVertrag[];
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.vertragService
        ...
        .subscribe(
          (res: HttpResponse<IVertrag[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInVertrags(): void {
    this.eventSubscriber = this.eventManager.subscribe('vertragListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IVertrag[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
