package de.is2.kundenportal.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.is2.kundenportal.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.is2.kundenportal.repository.UserRepository.USERS_BY_EMAIL_CACHE);
