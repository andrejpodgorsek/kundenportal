...
import { SelfServicesComponent } from 'app/entities/self-services/self-services.component';
...
describe('Component Tests', () => {
  describe('SelfServices Management Component', () => {
    let comp: SelfServicesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SelfServicesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.selfServices && comp.selfServices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
