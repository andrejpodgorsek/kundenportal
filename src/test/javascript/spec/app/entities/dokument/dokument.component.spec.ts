...
import { DokumentComponent } from 'app/entities/dokument/dokument.component';
...
describe('Component Tests', () => {
  describe('Dokument Management Component', () => {
    let comp: DokumentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DokumentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dokuments && comp.dokuments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
