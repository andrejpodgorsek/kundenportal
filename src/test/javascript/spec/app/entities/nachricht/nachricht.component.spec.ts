...
import { NachrichtComponent } from 'app/entities/nachricht/nachricht.component';
...
describe('Component Tests', () => {
  describe('Nachricht Management Component', () => {
    let comp: NachrichtComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NachrichtComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.nachrichts && comp.nachrichts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
