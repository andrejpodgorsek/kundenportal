...
import { AgenturComponent } from 'app/entities/agentur/agentur.component';
import { AgenturService } from 'app/entities/agentur/agentur.service';
import { Agentur } from 'app/shared/model/agentur.model';

describe('Component Tests', () => {
  describe('Agentur Management Component', () => {
    let comp: AgenturComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AgenturComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.agenturs && comp.agenturs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
